<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">Tambah Rekam Gigi <?php echo e($pasien->nama); ?></li>
            </ol>
        </nav>

        <?php echo $__env->make('rekam.partial.modal-diagnosa-gigi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <form id="rekamGigiForm" action="<?php echo e(Route('rekam.gigi.store', $pasien->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="pemeriksaan" id="kondisi_gigi" class="form-control">
                                    <?php $__currentLoopData = $kondisi_gigi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="table-tindakan" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $pem_gigi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($row->elemen_gigi); ?><input type="hidden" name="element_gigi[]"
                                                value="<?php echo e($row->elemen_gigi); ?>" />
                                        </td>
                                        <td><?php echo e($row->pemeriksaan); ?><input type="hidden" name="pemeriksaan[]"
                                                value="<?php echo e($row->pemeriksaan); ?>" />
                                        </td>
                                        <td><?php echo e($row->diagnosa); ?><input type="hidden" name="diagnosa[]"
                                                value="<?php echo e($row->diagnosa); ?>" /></td>
                                        <td><?php echo e($row->tindakan); ?><input type="hidden" name="tindakan[]"
                                                value="<?php echo e($row->tindakan); ?>" /></td>
                                        <td>
...
<?php $__env->startSection('header'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('rekam/css/rekamgigi.css')); ?>">
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('rekam/js/rekamgigi.js')); ?>"></script>
    <script>
        var itemGigi = <?php echo $elemen_gigis; ?>;
        var itemPem = <?php echo $pemeriksaan_gigi; ?>;
        var icdDataUrl = "<?php echo e(route('icd.data')); ?>";
        var opsiEdukasiUrl = "<?php echo e(route('opsiview.opsiedukasi')); ?>";
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Vista Pramudya\sigemoy\resources\views/rekam/rekam-gigi.blade.php ENDPATH**/ ?>