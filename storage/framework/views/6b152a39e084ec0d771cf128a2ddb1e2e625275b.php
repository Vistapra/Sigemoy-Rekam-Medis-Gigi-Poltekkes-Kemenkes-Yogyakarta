...
<head>
    ...
    <link href="<?php echo e(asset('vendor/sweetalert2/dist/sweetalert2.min.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <?php echo $__env->make('layout.partial.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    ...
    <script src="<?php echo e(asset('js/kuisioner.js')); ?>"></script>
    ...
    <script>
        ...
        <?php if(Session::has('sukses')): ?>
            showMessage('success', 'Sukses', "<?php echo e(Session::get('sukses')); ?>");
        <?php endif; ?>
        <?php if(Session::has('gagal')): ?>
            showMessage('error', 'Gagal', "<?php echo e(Session::get('gagal')); ?>");
        <?php endif; ?>
        ...
        var role = "<?php echo e(auth()->user()->role_display()); ?>";
...
<?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/layout/apps.blade.php ENDPATH**/ ?>