    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(Route('tindakan.update')); ?>" method="POST" enctype="multipart/form-data">
...
<?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/rekam/partial/modal-tindakan.blade.php ENDPATH**/ ?>