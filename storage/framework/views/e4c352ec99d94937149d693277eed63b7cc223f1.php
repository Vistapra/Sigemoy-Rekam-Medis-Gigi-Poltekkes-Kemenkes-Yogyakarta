...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('mobile/loginterapis.css')); ?>">
</head>
...
<body class="h-100">
    <div class="wrapper">
        ...
        <form action="<?php echo e(Route('login.auth')); ?>" method="POST">
            ...
            <div class="text-center">
                <a href="<?php echo e(Route('login_kader_kesehatan')); ?>">Login Sebagai Kader Kesehatan</a>
            </div>
        </form>
    </div>
    ...
    <script>
        <?php if(Session::has('sukses')): ?>
            toastr.success("<?php echo e(Session::get('sukses')); ?>", "Sukses", { timeOut: 5000 });
        <?php endif; ?>
        <?php if(Session::has('gagal')): ?>
            toastr.error("<?php echo e(Session::get('gagal')); ?>", "Gagal", { timeOut: 5000 });
        <?php endif; ?>
    </script>
</body>

</html>
<?php /**PATH /home/bumn7534/sigemoy/resources/views/auth/login_terapis_gigi.blade.php ENDPATH**/ ?>