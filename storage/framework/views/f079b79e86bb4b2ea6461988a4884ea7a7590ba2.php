<?php $query = app('App\Models\DashboardQuery'); ?>


<?php $__env->startSection('content'); ?>
    <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
        <div class="mr-auto">
            <h2 class="text-black font-w600">Dashboard Dokter</h2>
            <p class="mb-0">Dr. <?php echo e(auth()->user()->name); ?></p>
        </div>
    </div>
    <div class="row">
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            <h2 class="fs-34 text-black font-w600"><?php echo e($query->pasienHariini()); ?></h2>
        ...
        <div class="col-xl-3  col-sm-6">
            <div class="card">
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            <h2 class="fs-34 text-black font-w600"><?php echo e($query->totalPasien()); ?></h2>
        ...
        <div class="col-xl-3  col-sm-6">
            <div class="card">
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            <h2 class="fs-34 text-black font-w600"><?php echo e($query->totalPeriksa()); ?></h2>
        ...
        <div class="col-xl-6">
            <div class="card appointment-schedule">
                <div class="card-header pb-0 border-0">
                    <h3 class="fs-20 text-black mb-0">Riwayat Pasien</h3>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(route('dashboard')); ?>" method="GET" class="mb-3">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Cari nama pasien..." name="search" value="<?php echo e($search ?? ''); ?>">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $rekamMedis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('rekam.detail', $item->pasien_id)); ?>" class="text-primary"><?php echo e($item->pasien->nama); ?></a></td>
                                        <td><?php echo e($item->created_at->diffForHumans()); ?></td>
                                        <td><?php echo e($item->keluhan); ?></td>
                                        <td><?php echo e($item->user->name); ?></td>
                                        <td>
                                            <a href="<?php echo e(route('rekam.detail', $item->pasien_id)); ?>" class="btn btn-sm btn-outline-primary">
                                                <i class="las la-eye mr-1"></i>Lihat Detail
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="alert alert-info alert-dismissible fade show">
                                                <strong>Info!</strong> Tidak Ada Riwayat Pasien
                                            </div>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                    ...
                    <?php if($rekamMedis->hasPages()): ?>
                        <div class="pagination-wrapper py-4">
                            <ul class="pagination justify-content-center">
                                
                                <?php if($rekamMedis->onFirstPage()): ?>
                                    <li class="page-item disabled" aria-disabled="true" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">
                                        <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                    </li>
                                <?php else: ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?php echo e($rekamMedis->previousPageUrl()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">&lsaquo;</a>
                                    </li>
                                <?php endif; ?>

                                
                                <?php $__currentLoopData = $rekamMedis->getUrlRange(max($rekamMedis->currentPage() - 1, 1), min($rekamMedis->currentPage() + 1, $rekamMedis->lastPage())); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($page == $rekamMedis->currentPage()): ?>
                                ...
                                <?php if($rekamMedis->hasMorePages()): ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?php echo e($rekamMedis->nextPageUrl()); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>">&rsaquo;</a>
                                    </li>
                                <?php else: ?>
                    ...
                    <div class="card">
                        <div class="card-header d-sm-flex d-block pb-0 border-0">
                            <div class="mr-auto pr-3">
                                <h4 class="text-black fs-20 mb-0">Statistik Pasien</h4>
                            </div>
                                ...
                                <div class="tab-pane fade show active" id="Daily" role="tabpanel">
                                    <div class="d-flex flex-wrap align-items-center px-4 bg-light">
                                        <div class="mr-auto d-flex align-items-center py-3">
                                            ...
                                            <div>
                                                <p class="fs-18 mb-2">Total Pasien Hari Ini</p>
                                                <span
                                                    class="fs-26 text-primary font-w600"><?php echo e($query->pasienHariini()); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="Monthly" role="tabpanel">
                                    <div class="d-flex flex-wrap align-items-center px-4 bg-light">
                                        <div class="mr-auto d-flex align-items-center py-3">
                                            ...
                                            <div>
                                                <p class="fs-18 mb-2">Total Pasien Bulan Ini</p>
                                                <span
                                                    class="fs-26 text-primary font-w600"><?php echo e($query->perikaBulanini()); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="Yearly" role="tabpanel">
                                    <div class="d-flex flex-wrap align-items-center px-4 bg-light">
                                        <div class="mr-auto d-flex align-items-center py-3">
                                            ...
                                            <div>
                                                <p class="fs-18 mb-2">Total Pasien Tahun Ini</p>
                                                <span
                                                    class="fs-26 text-primary font-w600"><?php echo e($query->perikaTahunini()); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header d-sm-flex d-block pb-0 border-0">
                            ...
                            <div class="card-action card-tabs mt-3 mt-sm-0 mt-3 mb-sm-0 mb-3 mt-sm-0">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#MonthlyDiagnosa"
                                            role="tab">
                                            Bulanan
                                        </a>
                                    </li>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="MonthlyDiagnosa" role="tabpanel">
                                    <?php $__empty_1 = true; $__currentLoopData = $query->diagnosaBulanan(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="d-flex mb-3 align-items-center">
                                            <span class="mr-2 rounded-circle bg-primary"
                                                style="width:20px;height:20px;"></span>
                                            <span class="fs-14 text-black mr-auto d-inline-block text-truncate"
                                                style="max-width: 180px;"><?php echo e($item->diagnosa); ?> -
                                                <?php echo e($item->name_id); ?></span>
                                            <span class="fs-14 text-primary font-w600"><?php echo e($item->total); ?></span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <div class="alert alert-info">Tidak ada data diagnosa bulan ini.</div>
                                    <?php endif; ?>
                                </div>
                                <div class="tab-pane fade" id="YearlyDiagnosa" role="tabpanel">
                                    <?php $__empty_1 = true; $__currentLoopData = $query->diagnosaYearly(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="d-flex mb-3 align-items-center">
                                            <span class="mr-2 rounded-circle bg-primary"
                                                style="width:20px;height:20px;"></span>
                                            <span class="fs-14 text-black mr-auto d-inline-block text-truncate"
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <div class="alert alert-info">Tidak ada data diagnosa tahun ini.</div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Vista Pramudya\sigemoy\resources\views/dashboard/dokter.blade.php ENDPATH**/ ?>