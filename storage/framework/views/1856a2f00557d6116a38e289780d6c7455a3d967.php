    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#tindakanTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('tindakan.data')); ?>",
                    type: 'GET',
            ...
            $('#addTindakanForm').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "<?php echo e(route('tindakan.store')); ?>",
                    method: 'POST',
                    data: $(this).serialize(),
            ...
            $('#tindakanTable').on('click', '.edit-tindakan', function() {
                var id = $(this).data('id');
                $.get("<?php echo e(url('tindakan')); ?>/" + id + "/edit", function(data) {
                    $('#edit_id').val(data.id);
            ...
            $('#editTindakanForm').on('submit', function(e) {
                ...
                var id = $('#edit_id').val();
                $.ajax({
                    url: "<?php echo e(url('tindakan')); ?>/" + id,
                    method: 'POST',
                    data: $(this).serialize(),
                    success: function(response) {
...
<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/tindakan/index.blade.php ENDPATH**/ ?>