...
<?php $__env->startSection('content'); ?>
    <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
        <div class="mr-auto">
            <h2 class="text-black font-w600">Dashboard Kader Kesehatan</h2>
            <p class="mb-0">Dokter <?php echo e(auth()->user()->name); ?></p>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                            <h2 class="fs-34 text-black font-w600">
                                <?php echo e($query->pasienHariini()); ?>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="YearlyDiagnosa" role="tabpanel">
                                    ...
                                    <?php $__currentLoopData = $query->diagnosaYearly(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="d-flex mb-4 align-items-center">
                                            ...
                                            <span><?php echo e($item->diagnosa . ' '); ?></span>
                                            <span style="width: 300px" class="font-w300"><?php echo e($item->name_id); ?></span>
                                ...
                                <div class="tab-pane fade show active" id="MonthlyDiagnosa" role="tabpanel">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-xl-6 col-xxl-12 col-md-6">
                                            <?php $__currentLoopData = $query->diagnosaBulanan(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="d-flex mb-4 align-items-center">
                                                    <span class="mr-auto pr-3 font-w500 fs-30 text-black">
                                                    ...
                                                    <span style="width: 300px"
                                                        class="font-w300"><?php echo e($item->name_id); ?></span>
...
<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Vista Pramudya\sigemoy\resources\views/dashboard/kaderkesehatan.blade.php ENDPATH**/ ?>