...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">Edit Rekam Gigi <?php echo e($pasien->nama); ?></li>
            </ol>
        </nav>
        ...
        <form id="rekamGigiForm" action="<?php echo e(route('rekam.gigi.update', $pasien->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="pemeriksaan" id="kondisi_gigi" class="form-control">
                                    <?php $__currentLoopData = $kondisi_gigi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->kode); ?>"><?php echo e($item->kode); ?> || <?php echo e($item->nama); ?>
                                ...
                                <?php $__currentLoopData = $pem_gigi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($row->elemen_gigi); ?><input type="hidden" name="element_gigi[]"
                                                value="<?php echo e($row->elemen_gigi); ?>" /></td>
                                        <td><?php echo e($row->pemeriksaan); ?><input type="hidden" name="pemeriksaan[]"
                                                value="<?php echo e($row->pemeriksaan); ?>" /></td>
    ...
    <script>
        jQuery(function() {
            ...
            function ViewModel() {
                ...
                var itemGigi = "<?php echo e($elemen_gigis); ?>";
                var itemPem = "<?php echo e($pemeriksaan_gigi); ?>";
                            ...
                            success: function(response) {
                                Swal.fire({
                                    ...
                                    window.location.href =
                                        "<?php echo e(route('rekam.detail', $pasien->id)); ?>";
                                });
                            },
                            error: function(xhr) {
                                Swal.fire({
...
<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/rekam/edit-rekam-gigi.blade.php ENDPATH**/ ?>