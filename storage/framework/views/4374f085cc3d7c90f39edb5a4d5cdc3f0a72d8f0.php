...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('mobile/login.css')); ?>">
</head>
...
<body class="h-100">
    <div class="wrapper">
        ...
        <a href="<?php echo e(route('login_kader_kesehatan')); ?>" class="btn">
            <i class="fas fa-user-md"></i>KADER KESEHATAN
        </a>
        <a href="<?php echo e(route('login_terapis_gigi')); ?>" class="btn">
...
<?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/auth/login.blade.php ENDPATH**/ ?>