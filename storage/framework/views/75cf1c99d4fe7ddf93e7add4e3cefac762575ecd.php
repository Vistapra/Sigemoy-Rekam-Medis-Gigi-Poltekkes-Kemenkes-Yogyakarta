        ...
        jQuery(function() {
            ...
            function drawDiente(svg, parentGroup, diente) {
                ...
                [caraSuperior, caraInferior, caraDerecha, caraIzquierda, caraCentral, caraCompleto].forEach(
                    function(cara) {
                        $(cara).click(function() {
                            console.log("Clicked tooth:", diente.id, "Face:", $(this).data('cara'));
                            ...
                            success: function(response) {
                                Swal.fire({
                                    ...
                                    window.location.href =
                                        "<?php echo e(route('opsiview.opsiedukasi')); ?>";
                                });
                            },
                            error: function(xhr) {
                                Swal.fire({
...
<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/rekam/rekam-gigi.blade.php ENDPATH**/ ?>