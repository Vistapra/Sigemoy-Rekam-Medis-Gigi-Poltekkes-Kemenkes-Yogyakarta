            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    <li class="nav-item dropdown notification_dropdown dropdown-notifications">
                        <a class="nav-link  ai-icon dropdown-toggle" href="javascript:void(0)" role="button"
                            ...
                            <span class="badge light text-white bg-primary">
                                <span class="notif-count"><?php echo e(auth()->user()->unreadnotifications->count()); ?></span>
                            </span>
                        </a>
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                ...
                                                <div class="media-body">
                                                    <h6 class="mb-1"><?php echo e($notif->data['no_rekam']); ?></h6>
                                                    <h6 class="mb-1"><?php echo e($notif->data['message']); ?></h6>
                                                    <small
                                                        class="d-block"><?php echo e(\Carbon\Carbon::parse($notif->data['created_at'])->format('d/m/Y H:i:s')); ?></small>
                                                    <a href="<?php echo e(Route('rekam.detail', $notif->data['id_pasien'])); ?>">Klik
                                                        Proses</a>
                                                </div>
                                            </div>
                                        </li>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            <div class="header-info">
                                <span class="text-black">Hello, <strong><?php echo e(auth()->user()->name); ?></strong></span>
                            </div>
                            <img src="<?php echo e(asset('images/profile.png')); ?>" width="20" alt="" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
...
<?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/layout/partial/header.blade.php ENDPATH**/ ?>