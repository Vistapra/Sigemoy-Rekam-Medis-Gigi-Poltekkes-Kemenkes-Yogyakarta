        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            <form method="GET" action="<?php echo e(route('toga.index')); ?>" class="search-form">
                        ...
                        <?php if(request('search')): ?>
                            <div class="alert alert-info">
                                ...
                                <a href="<?php echo e(route('toga.index')); ?>" class="float-right">Reset</a>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="row" id="togaContent">
                            <?php $__empty_1 = true; $__currentLoopData = $toga; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="col-md-4 col-lg-3 mb-4">
                                    <div class="card h-100 toga-card">
                                        <div class="toga-media">
                                            <a href="<?php echo e(route('toga.show', $item->id)); ?>" class="d-block h-100">
                                                <?php if($item->foto): ?>
                                                    <img src="<?php echo e(Storage::url($item->foto)); ?>" alt="<?php echo e($item->judul); ?>"
                                                        class="card-img-top lazy"
                                                        data-src="<?php echo e(Storage::url($item->foto)); ?>">
                                                <?php else: ?>
                                        ...
                                        <div class="card-body">
                                            <a href="<?php echo e(route('toga.show', $item->id)); ?>" class="text-decoration-none">
                                                <h5 class="text-primary card-title"><?php echo e(Str::limit($item->judul, 30)); ?></h5>
                                            </a>
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <button type="button" class="btn btn-sm btn-outline-primary edit-btn"
                                                        data-id="<?php echo e($item->id); ?>" data-judul="<?php echo e($item->judul); ?>"
                                                        data-deskripsi="<?php echo e($item->deskripsi); ?>"
                                                        data-foto="<?php echo e($item->foto ? Storage::url($item->foto) : ''); ?>">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <form action="<?php echo e(route('toga.destroy', $item->id)); ?>" method="POST"
                                                        class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="submit"
                                                            class="btn btn-sm btn-outline-danger delete-btn"
                                                            data-name="<?php echo e($item->judul); ?>">
                        ...
                        <div class="d-flex justify-content-center my-4">
                            <?php echo e($toga->appends(request()->query())->links('pagination::bootstrap-4')); ?>
    ...
    <div class="modal fade" id="addTogaModal" tabindex="-1" role="dialog" aria-labelledby="addTogaModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('toga.store')); ?>" method="POST" enctype="multipart/form-data" id="addTogaForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/toga/index.blade.php ENDPATH**/ ?>