    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addIcdForm').submit(function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('icd.store')); ?>",
                    method: 'POST',
                    data: data,
...
<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/icd/index.blade.php ENDPATH**/ ?>