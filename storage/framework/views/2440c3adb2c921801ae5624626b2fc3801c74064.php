        ...
        <div class="card-body">
            <form action="<?php echo e(route('rekammediskaderkesehatan.store')); ?>" method="POST" id="rekamKaderForm"
                ...
                <div class="row g-4 mb-4">
                    <div class="col-12 col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="pasienNama" value="<?php echo e($pasien->nama); ?>" readonly>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="petugasNama" value="<?php echo e(Auth::user()->name); ?>"
                                readonly>
                ...
                <div class="mt-4 d-flex flex-column flex-md-row gap-3 justify-content-md-end">
                    ...
                    <a href="<?php echo e(route('rekammediskaderkesehatan.index')); ?>" class="btn btn-outline-secondary btn-lg">
...
<?php echo $__env->make('layout.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT 2024\Sigemoy\Development\sigemoy\resources\views/rekammediskaderkesehatan/create.blade.php ENDPATH**/ ?>