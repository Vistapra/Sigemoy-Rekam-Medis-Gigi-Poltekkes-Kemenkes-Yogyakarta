        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-responsive-md">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#editObat{{$row->id}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                        <a href="#" class="btn btn-danger shadow btn-xs sharp delete" r-link="{{Route('obat.delete',$row->id)}}" r-name="{{$row->nama}}" r-id="{{$row->id}}"><i class="fa fa-trash"></i></a>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{Route('obat.update',$row->id)}}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="text-black font-w500">Kode Obat*</label>
                                                                <input type="text" name="kd_obat" required
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label
                                                                            class="text-black font-w500">Satuan*</label>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label
                                                                            class="text-black font-w500">Stok*</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label
                                                                            class="text-black font-w500">Harga*</label>
                    ...
                    <div class="dataTables_info" id="example_info"  aria-live="polite">Showing
                        {{$datas->firstItem()}} to {{$datas->perPage() * $datas->currentPage()}} of {{$datas->total()}}
                        entries</div>
