                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="status_menikah" class="form-control">
                                        ...
                                        <option value="Belum Menikah"
                                            {{ $data->status_menikah == 'Belum Menikah' ? 'selected' : '' }}>Belum Menikah
                                        </option>
                                        <option value="Menikah" {{ $data->status_menikah == 'Menikah' ? 'selected' : '' }}>
                                            Menikah</option>
                                        <option value="Duda" {{ $data->status_menikah == 'Duda' ? 'selected' : '' }}>Duda
                                        </option>
                                        <option value="Janda" {{ $data->status_menikah == 'Janda' ? 'selected' : '' }}>
                                            Janda
                                        </option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2">
                                    <select name="agama" class="form-control">
                                        ...
                                        <option value="Hindu" {{ $data->agama == 'Hinda' ? 'selected' : '' }}>Hindu
                                        </option>
                                ...
                                <div class="col-sm-2">
                                    <select name="pendidikan" class="form-control">
                                        ...
                                        <option value="SMP" {{ $data->pendidikan == 'SMP' ? 'selected' : '' }}>SMP
                                        </option>
                                        <option value="SMA" {{ $data->pendidikan == 'SMA' ? 'selected' : '' }}>SMA
                                        </option>
                                        <option value="Diploma" {{ $data->pendidikan == 'Diploma' ? 'selected' : '' }}>
                                            Diploma
                                        </option>
                                        <option value="S1" {{ $data->pendidikan == 'S1' ? 'selected' : '' }}>S1
                                        </option>
                                        <option value="S2" {{ $data->pendidikan == 'S2' ? 'selected' : '' }}>S2
                                        </option>
                                        <option value="S3" {{ $data->pendidikan == 'S3' ? 'selected' : '' }}>S3
                                        </option>
                                        <option value="Tidak Sekolah"
                                            {{ $data->pendidikan == 'Tidak Sekolah' ? 'selected' : '' }}>Tidak Sekolah
                                        </option>
                                    </select>
                                    @error('pendidikan')
                                        <div class="invalid-feedback animated fadeInUp" style="display: block;">
                                ...
                                <div class="col-sm-2">
                                    <select name="pekerjaan" class="form-control">
                                        <option value="">--Pilih--</option>
                                        <option value="PNS" {{ $data->pekerjaan == 'PNS' ? 'selected' : '' }}>PNS
                                        </option>
                                        <option value="Wiraswasta"
                                            {{ $data->pekerjaan == 'Wiraswasta' ? 'selected' : '' }}>
                                            Wiraswasta</option>
                                        <option value="TNI/Polri" {{ $data->pekerjaan == 'TNI/Polri' ? 'selected' : '' }}>
                                            TNI/Polri</option>
                                        ...
                                        <option value="Guru/Pengajar"
                                            {{ $data->pekerjaan == 'Guru/Pengajar' ? 'selected' : '' }}>Guru/Pengajar
                                        </option>
                                        <option value="IRT" {{ $data->pekerjaan == 'IRT' ? 'selected' : '' }}>IRT
                                        </option>
                                        <option value="Lain-Lain" {{ $data->pekerjaan == 'Lain-Lain' ? 'selected' : '' }}>
                                            Lain-Lain</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="kelurahan"
                                        value="{{ old('kelurahan') ? old('kelurahan') : $data->kelurahan }}">
                                    @error('kelurahan')
                                        <div class="invalid-feedback animated fadeInUp" style="display: block;">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="kecamatan"
                                        value="{{ old('kecamatan') ? old('kecamatan') : $data->kecamatan }}">
                                    @error('kecamatan')
                                        <div class="invalid-feedback animated fadeInUp" style="display: block;">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="kabupaten"
                                        value="{{ old('kabupaten') ? old('kabupaten') : $data->kabupaten }}">
                                    @error('kabupaten')
                                        <div class="invalid-feedback animated fadeInUp" style="display: block;">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="number" maxlength="5" class="form-control" name="kodepos"
                                        value="{{ old('kodepos') ? old('kodepos') : $data->kodepos }}">
                                    @error('kodepos')
                                        <div class="invalid-feedback animated fadeInUp" style="display: block;">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" name="no_hp"
                                        value="{{ old('no_hp') ? old('no_hp') : $data->no_hp }}">
                                    @error('no_hp')
                                        <div class="invalid-feedback animated fadeInUp" style="display: block;">
                                            {{ $message }}
                                        </div>
