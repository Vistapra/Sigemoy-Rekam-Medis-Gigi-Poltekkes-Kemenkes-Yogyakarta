...
@section('content')
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">Odontogram {{ $pasien->nama }}</li>
            </ol>
        </nav>
        ...
        <div class="row">
            ...
            <div class="col-xl-3">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <a href="{{ route('rekam.gigi.edit', $pasienId) }}" class="btn btn-primary btn-block mb-3">
                            <i class="fas fa-edit"></i> Edit Odontogram
                        </a>
                        <h5 class="card-title mb-3">Panduan Odontogram</h5>
                        <table class="table table-sm table-hover">
                            <tbody>
                                @forelse($kondisi_gigi as $kondisi)
                                    <tr>
                                        <td><span class="badge"
                                                style="background-color: {{ $kondisi->color }}">{{ $kondisi->kode }}</span>
                                        </td>
                                        <td>{{ $kondisi->nama }}</td>
                                    </tr>
                                @empty
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="table-riwayat" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @forelse($all_riwayat_gigi as $riwayat)
                                <tr>
                                    <td>{{ $riwayat->created_at->format('d-m-Y') }}</td>
                                    <td>{{ $riwayat->elemen_gigi }}</td>
    ...
    <script>
        jQuery(function() {
            ...
            function renderSvg() {
                ...
                var odontogramData = {!! json_encode($odontogram_data) !!};
