            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a href="{{Route('rekam',['tab'=>1])}}" class="nav-link
                    {{Request('tab')==1 ? 'active' :''}}" >
                    ...
                    @else --}}
                        {{-- @if (auth()->user()->role_display() == 'Dokter' || auth()->user()->role_display() == 'KaderKesehatan')
                            <li class="nav-item">
                        ...
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                @foreach ($rekam as $key => $row)
                                    <tr>
                                        <td align="center">{{ $rekam->firstItem() + $key }}</td>
